...
namespace genetic_algorithm_ts
{
    public class Genome
    {
        ...
        public void Crossover(ref Genome genome2, out Genome child1, out Genome child2)
        {
            ...
            List<double> genomeDifference = genome2._mGenes.GetRange(iSecStart, sectionSize);
        ...
        public void Mutate()
        {
            ...
            int iGene1 = new RandomNumberGenerator().Generate(0, _mGenes.Count - 1);
            int iGene2 = new RandomNumberGenerator().Generate(0, _mGenes.Count - 1);

            (_mGenes[iGene1], _mGenes[iGene2]) = (_mGenes[iGene2], _mGenes[iGene1]);
        }
